...
//	@Ignore
	...
	private Set<AttributeDefinition> generateAttributeDefinitions() {
		...
		res.add(new AttributeDefinitionString("url:Firstname","url:Firstname",0,16));
		res.add(new AttributeDefinitionString("url:Lastname","url:Lastname",0,123));
		res.add(new AttributeDefinitionString("url:Town","url:Town",0,123));
