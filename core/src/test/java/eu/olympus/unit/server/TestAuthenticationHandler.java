...
public class TestAuthenticationHandler {
    ...
    @Test
    public void testRefreshCookieLookupFails() {
        PestoDatabase db = mockDb();
    ...
    @Test
    public void testRefreshCookieStoreFails() {
        PestoDatabase db = mockDb();
        UserAuthorizationDatabase sessions = mock(UserAuthorizationDatabase.class);
    ...
    @Test
    public void testRefreshCookieDeleteCookieFails() {
        PestoDatabase db = mockDb();
        UserAuthorizationDatabase sessions = mock(UserAuthorizationDatabase.class);
        doReturn(new Authorization()).when(sessions).lookupCookie(anyString());
    ...
    public void testValidateSession() throws AuthenticationFailedException {
        PestoDatabase db = mockDb();
